...
const translations = {
  pt: {
    ...
    proj7_desc: "Ferramenta open source para monitoramento pluviometrico no Rio de Janeiro. Java 25 com Virtual Threads para concorrencia escalavel de alta performance.",
    proj8_desc: "Sistema transacional completo para analise e solicitacao de credito escrito em Kotlin. Clean Architecture, SOLID e Spring Boot.",
    proj9_desc: "Aplicacao web fullstack em TypeScript com uso disciplinado de Domain-Driven Design e arquitetura limpa ponta a ponta.",
    proj10_desc: "Analisador filosofico baseado em Schopenhauer com IA. Identifica falacias e padroes argumentativos em textos. Express, SQLite e Docker.",
    ...
    exp2_desc: "Microsservicos Java/Kotlin para controle de disponibilidade e reservas. Aplicativos mobiles hibridos (Android/React Native), painel web Vue.js e integracao via RabbitMQ com Swagger APIs.",
    exp_lj2_clients: "Clientes: Share Aero + NexMov",
    exp_lj2_desc: "Portal web para compartilhamento de dados aeronauticos (Share Aero — ReactJS/Tailwind com Jest) e solucoes mobile de mobilidade urbana com mapas nativos (NexMov — React Native + Node.js).",
    ...
    tech_analytics: "// Analytics & Tracking",
  ...
  en: {
    ...
    proj7_desc: "Open source tool for rainfall monitoring in Rio de Janeiro. Java 25 with Virtual Threads for scalable, high-performance concurrency.",
    proj8_desc: "End-to-end transactional system for credit analysis and application written in Kotlin. Clean Architecture, SOLID principles and Spring Boot.",
    proj9_desc: "End-to-end fullstack web application in TypeScript showcasing disciplined and structured use of Domain-Driven Design and clean architecture.",
    proj10_desc: "Philosophical analyser based on Schopenhauer with AI. Identifies fallacies and argumentative patterns in texts. Express, SQLite and Docker.",
    ...
    exp2_desc: "Java/Kotlin microservices for availability control and reservations. Hybrid mobile apps (Android/React Native), Vue.js web portal and RabbitMQ integrations via Swagger APIs.",
    exp_lj2_clients: "Clients: Share Aero + NexMov",
    exp_lj2_desc: "Web portal for aeronautical data sharing (Share Aero — ReactJS/Tailwind with Jest coverage) and urban mobility mobile solutions with native maps (NexMov — React Native + Node.js).",
